...
*/
    ...
    const STRINGS = ["Аэрокосмическая инженерия. Презентация",
                    ...
                    "Зачем нужно изучать новые планеты?     Найти \"запасную\" планету на случай, если с Землей что-нибудь случиться; добывать из разных планет полезные материалы и ископаемые, изучать их.",
